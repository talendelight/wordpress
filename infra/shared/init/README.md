...
Get-Content ../shared/init/251222-change.sql | podman exec -i wp-db mysql -u root -ppassword wordpress

# Method 2: Via WP-CLI
podman exec wordpress wp db query "$(Get-Content ../shared/init/251222-change.sql -Raw)"
```
...
```sql
-- File: infra/shared/init/251225-add-member-tiers.sql
...
```sql
-- File: infra/shared/init/260101-enable-maintenance-mode.sql
...
- [ ] Saved in `infra/shared/init/`
- [ ] Committed to version control

## See Also

- [infra/dev/DATABASE.md](../../dev/DATABASE.md) - Development database workflow
- [infra/prod/DATABASE.md](../../prod/DATABASE.md) - Production database management
