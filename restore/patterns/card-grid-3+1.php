...
<div class="wp-block-group alignfull has-gray-off-white-background-color has-background" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
    ...
    <h2 class="wp-block-heading has-text-align-center has-text-color" style="margin-bottom:64px;color:#063970">Section Heading</h2>
    <!-- /wp:heading -->

    <!-- wp:columns {"align":"wide","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|32","left":"var:preset|spacing|32"},"margin":{"top":"0","bottom":"0"}}}} -->
    <div class="wp-block-columns alignwide" style="gap:32px;margin-top:0;margin-bottom:0">
        <!-- wp:column -->
        <div class="wp-block-column">
            ...
            <div class="wp-block-group is-style-card has-white-background-color has-background" style="border-radius:12px;min-height:100%;padding-top:var(--wp--preset--spacing--48);padding-right:var(--wp--preset--spacing--48);padding-bottom:var(--wp--preset--spacing--48);padding-left:var(--wp--preset--spacing--48)">
                ...
                <div style="text-align:center;">
                    ...
                    <h3 style="font-size:24px;font-weight:700;color:#063970;margin:0;">Card 1 Title</h3>
                </div>
                <!-- /wp:html -->
                
                <!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"14px"},"color":{"text":"#666666"}}} -->
                <p class="has-text-align-center has-text-color" style="font-size:14px;color:#666666">Card 1 description text.</p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
        </div>
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group is-style-card has-white-background-color has-background" style="border-radius:12px;min-height:100%;padding-top:var(--wp--preset--spacing--48);padding-right:var(--wp--preset--spacing--48);padding-bottom:var(--wp--preset--spacing--48);padding-left:var(--wp--preset--spacing--48)">
                <!-- wp:html -->
                <div style="text-align:center;">
                    <i class="fas fa-globe" style="font-size:48px;color:#3498DB;display:block;margin-bottom:8px;"></i>
                    <h3 style="font-size:24px;font-weight:700;color:#063970;margin:0;">Card 2 Title</h3>
                </div>
                <!-- /wp:html -->
                
                <!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"14px"},"color":{"text":"#666666"}}} -->
                <p class="has-text-align-center has-text-color" style="font-size:14px;color:#666666">Card 2 description text.</p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
        </div>
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group is-style-card has-white-background-color has-background" style="border-radius:12px;min-height:100%;padding-top:var(--wp--preset--spacing--48);padding-right:var(--wp--preset--spacing--48);padding-bottom:var(--wp--preset--spacing--48);padding-left:var(--wp--preset--spacing--48)">
                <!-- wp:html -->
                <div style="text-align:center;">
                    <i class="fas fa-server" style="font-size:48px;color:#3498DB;display:block;margin-bottom:8px;"></i>
                    <h3 style="font-size:24px;font-weight:700;color:#063970;margin:0;">Card 3 Title</h3>
                </div>
                <!-- /wp:html -->
                
                <!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"14px"},"color":{"text":"#666666"}}} -->
                <p class="has-text-align-center has-text-color" style="font-size:14px;color:#666666">Card 3 description text.</p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
        </div>
        ...
        <div class="wp-block-column">
            ...
            <div class="wp-block-group is-style-card has-white-background-color has-background" style="border-radius:12px;min-height:100%;padding-top:var(--wp--preset--spacing--48);padding-right:var(--wp--preset--spacing--48);padding-bottom:var(--wp--preset--spacing--48);padding-left:var(--wp--preset--spacing--48)">
                <!-- wp:html -->
                <div style="text-align:center;">
                    <i class="fas fa-question-circle" style="font-size:48px;color:#3498DB;display:block;margin-bottom:8px;"></i>
                    <h3 style="font-size:24px;font-weight:700;color:#063970;margin:0;">Card 4 Title</h3>
                </div>
                <!-- /wp:html -->
                
                <!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"14px"},"color":{"text":"#666666"}}} -->
                <p class="has-text-align-center has-text-color" style="font-size:14px;color:#666666">Card 4 description text.</p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
        </div>
